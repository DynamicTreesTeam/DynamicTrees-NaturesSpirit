...
import xueluoanping.dtnatures_spirit.ModConstants;

public class Lang_EN extends LangHelper {
    public Lang_EN(PackOutput gen, ExistingFileHelper helper) {
        super(gen, helper, DTNaturesSpirit.MOD_ID, "en_us");
    }


    @Override
    protected void addTranslations() {
        add(DTNaturesSpirit.MOD_ID, "Dynamic Trees for Fruitful Fun");
