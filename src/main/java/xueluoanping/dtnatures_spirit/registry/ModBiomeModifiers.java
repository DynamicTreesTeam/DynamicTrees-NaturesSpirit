...
public class ModBiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> createKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, DTNaturesSpirit.rl(name));
    }

    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        HolderGetter<Biome> holderGetter = context.lookup(Registries.BIOME);
        HolderGetter<PlacedFeature> placedFeatureHolderGetter = context.lookup(Registries.PLACED_FEATURE);
        context.register(REMOVE_CEDAR, new BiomeModifiers.RemoveFeaturesBiomeModifier(
        ...
        context.register(REMOVE_JOSHUA, new BiomeModifiers.RemoveFeaturesBiomeModifier(
